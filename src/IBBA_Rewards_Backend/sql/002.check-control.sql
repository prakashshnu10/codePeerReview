select  count(*) from
(SELECT DISTINCT * FROM (VALUES('get_admin'),('get_admin_treasury'),('get_all_reward_level'),('get_all_users'),('get_authenticate_user'),('get_badges'),
...
('get_user'),('get_user_name_using_reward_trx_hash'),('get_user_nft'),('get_user_nft_reward'),('get_unprocessed_direct_sale'),('get_immediate_hightier_users'),('get_user_nft_direct_reward'),('get_from_user_nft_direct_reward'),('get_user_nft_indirect_reward'),
